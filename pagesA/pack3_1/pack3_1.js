...
Page({
  ...
  data: {
    ...
    zy: "",
    style_imgs: [
      { "pack": "/images/pack7.png", "pack_show": "/images/pack7.png" }
    ],
    pack_show: '/images/pack7.png',
    bottom1: "450rpx",
    bottom2: "0",
    _num: 7,//纸套
    crop: ""
  ...
  next_step: function () {
    ...
    if (this.data._num === "") {
      ...
      warn = "请选择自定义图片"
    } else if (this.data.blessing == '不需要文字') {
      warn = "请填写祝福语"
    } else {
      flag = true;
  ...
  setCutimg: function (context) {
    context.drawImage(self.data.tempfp, 15, 137, 65, 118);
  },
  createNewImg: function () {
    ...
    context.drawImage(self.data.tempfp, 124, 65, 72, 160);
    //将纸套绘制到canvas
